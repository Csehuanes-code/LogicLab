...
public class XNOr extends Gate{
    ...
    //BUILDERS
    //**************************************************************************
    public XNOr(Point org){
        super(org, GateType.Or);
    }
    public XNOr(Point org, int width, int height, int pinCount){
        super(org, width, height, pinCount, GateType.XNOr);
    }
    ...
    public void draw(Graphics g) {
        ...
        path.moveTo(org.x - width/8, org.y + height - height/32);
        path.curveTo(org.x + width / 2 - width/8, org.y + height, org.x + width / 2 - width/8, org.y, org.x - width/8, org.y + height/32);  // Curva izquierda
        g2d.draw(path);
