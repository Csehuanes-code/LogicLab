...
public class NOr extends Gate{
    ...
    //BUILDERS
    //**************************************************************************
    public NOr(Point org){
        super(org, GateType.Or);
    }
    public NOr(Point org, int width, int height, int pinCount){
        super(org, width, height, pinCount, GateType.NOr);
    }
    ...
    public void draw(Graphics g) {
        ...
        g2d.drawOval(org.x + width - width/4, org.y + height/2 - invertorSize/2, invertorSize, invertorSize);
        
        // Salida
        g2d.setColor(Color.BLACK);
        g2d.drawLine(org.x + width - width/4 + invertorSize, org.y + height/2, org.x + width + width/4, org.y + height/2);
