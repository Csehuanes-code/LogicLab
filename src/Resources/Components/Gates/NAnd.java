...
public class NAnd extends Gate{
    ...
    //BUILDERS
    //**************************************************************************
    public NAnd(Point org){
        super(org, GateType.And);
    }
    public NAnd(Point org, int width, int height, int pinCount){
        super(org, width, height, pinCount, GateType.NAnd);
    }
    ...
    public void draw(Graphics g) {
        ...
        // OutPut
        g2d.setColor(Color.BLACK);
        g2d.drawLine(org.x + width + invertorSize, org.y + height/2, org.x + width + width/2, org.y + height/2);
